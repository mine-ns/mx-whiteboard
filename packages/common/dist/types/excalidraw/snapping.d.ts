...
export declare const isActiveToolNonLinearSnappable: (activeToolType: AppState["activeTool"]["type"]) => activeToolType is "text" | "ellipse" | "rectangle" | "diamond" | "frame" | "magicframe" | "image";
export {};
