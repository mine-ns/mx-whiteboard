...
export declare const isUsingAdaptiveRadius: (type: string) => type is "rectangle" | "embeddable" | "image" | "iframe";
export declare const isUsingProportionalRadius: (type: string) => type is "line" | "diamond" | "arrow";
